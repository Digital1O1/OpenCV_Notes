...
static void help()
{
    cout
        ...
        << "Syntax for Mat() -->  cv::Mat::Mat(int rows, int cols, int type); " << endl
        << "-----------------------------------------------------------------------------" << endl
        << endl;
}
...
int main(int, char **)
{
    ...
    //! [constructor]
    /*
        Specifying the data type to store elements and the number of channels per matrix point
        ...
        CV_8UC3 means
            ...
            - 8 bits long
            - Each pixel has three of these to form the three channels
                - They're predefined up to four channels
    */
